...
import { VerticalDetailData } from "@/data/verticals-detail-data";
...
export default function VerticalDetailView({ data }: { data: VerticalDetailData }) {
  const [isQuoteModalOpen, setIsQuoteModalOpen] = useState(false);

  return (
    <main className="w-full bg-[#F4F7FA] min-h-screen">
      {/* 1. Hero Section - Same design as ProductDetailView */}
      <section className="relative w-full bg-[#031B3D]">
        <Image
          src="/images/Hero/Hero8.webp"
          alt="Our Verticals-Background-Image"
          fill
          sizes="100vw"
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-32 pb-24 sm:pt-36 sm:pb-32 lg:pt-44 lg:pb-40 relative z-10 text-center flex flex-col items-center justify-center min-h-[400px] sm:min-h-[450px]">
          ...
          <div className="flex items-center justify-center gap-3 text-sm font-medium text-slate-300">
            ...
            {data.slug === "all" ? (
              <span className="text-[#00a7e1]">Verticals</span>
            ) : (
              <>
                <Link
                  href="/verticals"
        ...
        <div className="absolute bottom-[-20px] left-1/2 -translate-x-1/2 z-30 flex justify-center">
          <RequestQuoteButton onClick={() => setIsQuoteModalOpen(true)} />
        </div>
      </section>
      ...
      {data.slug === "all" ? (
        ...
        <>
          {/* 2. Featured Technology / Industry Solutions */}
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto mb-16">
                  ...
                  <p className="text-slate-600 text-lg">
                    Explore industry-leading solutions empowering organizations to thrive.
                  </p>
                </div>
                    ...
                    >
                      ...
                      <div className="p-6 flex flex-col flex-1">
                        ...
                        <button
                          ...
                          className="inline-flex items-center gap-2 text-sm font-bold text-[#0057B8] hover:text-[#00a7e1] transition-colors mt-auto cursor-pointer"
                        >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                  ...
                  <div className="relative w-full max-w-md mx-auto lg:max-w-full">
                    ...
                    <div className="absolute -bottom-6 -right-6 sm:bottom-10 sm:-right-10 bg-[#00a7e1] text-white p-6 sm:p-8 rounded-3xl shadow-2xl flex flex-col items-center justify-center text-center transform rotate-3">
                      <span className="text-3xl sm:text-4xl font-black mb-1 leading-none whitespace-pre-line">
            ...
            <section className="py-24 sm:py-32 bg-white">
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-3xl mx-auto mb-16">
                  ...
                  <p className="text-slate-600 text-lg">
                    Scalable engagement models built for organizations of all sizes.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
                  {data.pricing.plans.map((plan, idx) => (
                    ...
                    >
                      ...
                      <button
                        onClick={() => setIsQuoteModalOpen(true)}
                        className={`w-full py-3.5 rounded-xl font-bold mb-8 transition-colors cursor-pointer ${plan.isPopular
                            ...
                            >
                              {feature.included ? (
                                <IconifyIcon
                                  icon="lucide:check"
                                  width={14}
                                  className={plan.isPopular ? "text-[#00a7e1]" : ""}
                                />
                              ) : (
                                <IconifyIcon
                                  icon="lucide:minus"
                                  width={14}
                                  className={plan.isPopular ? "text-slate-500" : ""}
                                />
                              )}
                            </div>
                            <span
                ...
                <div className="relative rounded-[3rem] overflow-hidden bg-[#031B3D] flex flex-col md:flex-row items-center justify-between p-10 sm:p-16 shadow-2xl">
                  ...
                  <div className="relative z-10 max-w-lg mb-10 md:mb-0">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                      <button
                        onClick={() => setIsQuoteModalOpen(true)}
                        className="bg-[#00a7e1] hover:bg-[#008dbf] text-white px-8 py-3.5 rounded-full font-bold shadow-lg transition-all hover:scale-105 flex items-center justify-center gap-2 cursor-pointer"
                      >
                        Request a Demo
                      </button>
                      <button
                        onClick={() => setIsQuoteModalOpen(true)}
                        className="bg-white/10 hover:bg-white/20 text-white border border-white/20 px-8 py-3.5 rounded-full font-bold transition-all flex items-center justify-center gap-2 cursor-pointer"
                      >
                        Contact Sales
                      </button>
                    </div>
