...
export default function InternshipForm() {
  ...
  return (
    <div className="w-full">
      {/* 1. Header Hero Area */}
      <section
        aria-label="Internship Application Hero"
        className="relative w-full overflow-hidden bg-[#03122F] text-white pt-28 sm:pt-36 md:pt-40 lg:pt-44 pb-16 sm:pb-20 md:pb-24 px-4 sm:px-6 lg:px-8 border-b border-slate-800/60"
      >
        ...
        <Image
          ...
          priority
          sizes="100vw"
          className="object-fit object-center opacity-30 mix-blend-luminosity"
        />
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center">
          ...
          <nav aria-label="Breadcrumb" className="mb-4 sm:mb-5">
            <ol className="flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 text-[11px] sm:text-xs font-semibold tracking-wider uppercase text-slate-300">
              <li>
                <Link href="/" className="hover:text-[#1BA6C7] transition-colors">
                  HOME
                </Link>
              </li>
              <li className="text-slate-500">›</li>
              <li>
                <Link href="/Activities/Internship" className="hover:text-[#1BA6C7] transition-colors">
                  ACTIVITIES
                </Link>
              </li>
              <li className="text-slate-500">›</li>
              ...
              <li className="text-slate-500">›</li>
              <li className="text-[#1BA6C7]">APPLY</li>
            </ol>
          </nav>

          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full text-xs font-semibold bg-[#1BA6C7]/15 text-[#1BA6C7] border border-[#1BA6C7]/30 backdrop-blur-md mb-4 sm:mb-5">
            <span className="w-2 h-2 rounded-full bg-[#1BA6C7] animate-pulse" />
            <span>Official SPS Internship Portal</span>
          </div>

          {/* Heading */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-white mb-4 sm:mb-5 leading-tight">
            Start Your <span className="text-[#1BA6C7]">Professional Journey</span>
          </h1>
      ...
      {/* 2. Content Area */}
      <div className="min-h-[50vh] bg-[#fafbfe] py-12 sm:py-16 px-4 sm:px-6 lg:px-8 font-sans selection:bg-blue-600 selection:text-white">
        <div className="max-w-5xl mx-auto">
          {isSubmitted ? (
            <div className="max-w-2xl mx-auto my-8 p-8 bg-white border border-slate-100 shadow-2xl rounded-3xl text-center font-sans">
            ...
            <>
              {/* Intake Alert Banner (Clean Deep Blue Gradient) */}
              ...
              <form onSubmit={handleSubmit} className="bg-white border border-slate-100 rounded-3xl shadow-xl shadow-slate-200/50 p-6 md:p-12 space-y-12">
                        ...
                        <div className="p-6 border-t border-slate-100 bg-slate-50/20 space-y-6">
                          ...
                          <div className="space-y-3">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              <label className="flex items-center gap-3 p-4 border border-slate-200 rounded-xl bg-white hover:border-blue-300 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50/20 cursor-pointer transition">
                                <span className="relative flex items-center justify-center w-5 h-5 shrink-0">
                                  <input type="radio" defaultChecked name="proj_opt" className="peer h-5 w-5 appearance-none rounded-full border-2 border-slate-400 bg-white checked:border-blue-600 cursor-pointer transition-all" />
                                  <span className="pointer-events-none absolute w-2.5 h-2.5 rounded-full bg-blue-600 opacity-0 peer-checked:opacity-100 transition-opacity" />
                                </span>
                                <span className="text-sm font-bold text-slate-800">Business</span>
                              </label>
                              <label className="flex items-center gap-3 p-4 border border-slate-200 rounded-xl bg-white hover:border-blue-300 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50/20 cursor-pointer transition">
                                <span className="relative flex items-center justify-center w-5 h-5 shrink-0">
                                  <input type="radio" name="proj_opt" className="peer h-5 w-5 appearance-none rounded-full border-2 border-slate-400 bg-white checked:border-blue-600 cursor-pointer transition-all" />
                                  <span className="pointer-events-none absolute w-2.5 h-2.5 rounded-full bg-blue-600 opacity-0 peer-checked:opacity-100 transition-opacity" />
                                </span>
                      ...
                      {activePath === 'competence' && (
                        <div className="p-6 border-t border-slate-100 bg-slate-50/20 space-y-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <label className="flex items-center gap-3 p-4 border border-slate-200 rounded-xl bg-white hover:border-blue-300 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50/20 cursor-pointer transition">
                              <span className="relative flex items-center justify-center w-5 h-5 shrink-0">
                                <input type="radio" defaultChecked name="comp_opt" className="peer h-5 w-5 appearance-none rounded-full border-2 border-slate-400 bg-white checked:border-blue-600 cursor-pointer transition-all" />
                                <span className="pointer-events-none absolute w-2.5 h-2.5 rounded-full bg-blue-600 opacity-0 peer-checked:opacity-100 transition-opacity" />
                              </span>
                              <span className="text-sm font-bold text-slate-800">Business</span>
                            </label>
                            <label className="flex items-center gap-3 p-4 border border-slate-200 rounded-xl bg-white hover:border-blue-300 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50/20 cursor-pointer transition">
                              <span className="relative flex items-center justify-center w-5 h-5 shrink-0">
                                <input type="radio" name="comp_opt" className="peer h-5 w-5 appearance-none rounded-full border-2 border-slate-400 bg-white checked:border-blue-600 cursor-pointer transition-all" />
                                <span className="pointer-events-none absolute w-2.5 h-2.5 rounded-full bg-blue-600 opacity-0 peer-checked:opacity-100 transition-opacity" />
                              </span>
                              <span className="text-sm font-bold text-slate-800">Technical</span>
                            </label>
                        ...
                        <div className="p-6 border-t border-slate-100 bg-slate-50/20 space-y-4">
                          ...
                          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
                            {['Apple', 'AWS', 'Flutter Identity', 'Fortinet', 'IBM', 'Microsoft', 'TrendMicro'].map((partner) => (
                              <label key={partner} className="flex items-center gap-2.5 p-3 border border-slate-200 has-[:checked]:border-blue-600 has-[:checked]:bg-blue-50/30 rounded-xl bg-white hover:border-blue-400 cursor-pointer transition text-xs font-semibold text-slate-700 select-none">
                                <span className="relative flex items-center justify-center shrink-0">
                                  <input type="checkbox" className="peer h-5 w-5 appearance-none rounded-md border-2 border-slate-400 bg-white checked:bg-blue-600 checked:border-blue-600 cursor-pointer transition-all" />
                                  <Check className="pointer-events-none absolute w-3.5 h-3.5 text-white opacity-0 peer-checked:opacity-100 transition-opacity stroke-[3]" />
                                </span>
                                <span>{partner}</span>
                              </label>
                            ))}
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-6 pt-8 border-t border-slate-100">
                  ...
                  <div className="w-full md:w-auto md:max-w-xl">
                    <label
                      htmlFor="consent"
                      className={`flex items-start gap-3 p-4 rounded-2xl border transition duration-200 cursor-pointer select-none ${
                        errors.consent
                          ? 'bg-red-50/40 border-red-200 text-red-900'
                          : consentChecked
                          ? 'bg-blue-50/30 border-blue-600/60'
                    ...
                    >
                      <span className="relative flex items-center justify-center mt-0.5 shrink-0">
                        <input
                          ...
                          className="peer h-5 w-5 appearance-none rounded-md border-2 border-slate-400 bg-white checked:bg-blue-600 checked:border-blue-600 cursor-pointer transition-all"
                        />
                        <Check className="pointer-events-none absolute w-3.5 h-3.5 text-white opacity-0 peer-checked:opacity-100 transition-opacity stroke-[3]" />
                      </span>
