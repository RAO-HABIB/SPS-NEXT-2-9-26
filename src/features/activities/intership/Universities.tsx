...
const universities = [
  { name: 'COMSATS', logo: '/images/internship/comsats.png' },
  { name: 'AIR UNIVERSITY', logo: '/images/internship/air.png' },
  { name: 'FAST UNIVERSITY', logo: '/images/internship/fast.png' },
  { name: 'NUST', logo: '/images/internship/nust.png' },
  { name: 'BAHRIA UNIVERSITY', logo: '/images/internship/bahria.png' },
  { name: 'ISLAMIC UNIVERSITY', logo: '/images/internship/Islamic.png' },
  { name: 'VIRTUAL UNIVERSITY', logo: '/images/internship/virtual.png' },
  { name: 'FATIMA JINNAH', logo: '/images/internship/jinnah.jpeg' },
];
