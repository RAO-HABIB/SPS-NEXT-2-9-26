...
import {
  ProfessionalLeader1, BusinessStrategyIllustration
...
export default function GrcLayout() {
  return (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
          <div className="max-w-3xl">
            <div className="text-[#00a7e1] text-xs font-bold tracking-widest uppercase mb-4 flex items-center gap-2">
              ...
              <span>›</span>
              <span className="text-white uppercase">GRC</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-slate-200 leading-relaxed mb-8 font-light max-w-2xl">
              With complex technological environments, innovations like operational technology (OT), Internet of Things (IoT) and Quantum can leave your enterprise open to third-party security and IT regulatory compliance risks.
            </p>
