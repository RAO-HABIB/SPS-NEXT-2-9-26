...
import {
  WorkCommunicationIllustration, BusinessStrategyIllustration
...
export default function ThreatManagementLayout() {
  return (
      ...
      <section className="relative w-full min-h-[580px] sm:min-h-[640px] pt-32 sm:pt-36 lg:pt-40 pb-20 sm:pb-24 flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Threat Management Hero Background"
            fill
            sizes="100vw"
            className="object-cover object-center"
            priority
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
          <div className="max-w-3xl">
            <div className="text-[#00a7e1] text-xs font-bold tracking-widest uppercase mb-4 flex items-center gap-2">
              ...
              <span>›</span>
              <span className="text-white uppercase">THREAT MANAGEMENT</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-slate-200 leading-relaxed mb-8 font-light max-w-2xl">
              Safeguard sensitive assets, proactively protect privileged access, streamline threat response with SOAR, and expose external attack surface vulnerabilities.
            </p>
