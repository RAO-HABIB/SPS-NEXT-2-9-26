...
import {
  BusinessStrategyEssentials1, BusinessStrategyIllustration
...
const CUSTOMERS = [
  { name: "Allied Bank", image: "/images/customers/Allied-Bank.webp" },
...
export default function IdentityAccessLayout() {
  return (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 max-w-7xl">
          <div className="max-w-3xl">
            <div className="text-[#00a7e1] text-xs font-bold tracking-widest uppercase mb-4 flex items-center gap-2">
              ...
              <span>›</span>
              <span className="text-white uppercase">IDENTITY & ACCESS</span>
            </div>
            ...
            <p className="text-base sm:text-lg text-slate-200 leading-relaxed mb-8 font-light max-w-2xl">
              Our Enterprise Security practice has over 20 years of Identity & Access Management experience, and specializes in IBM Security Verify, IBM Security Identity Manager, and more.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              >
                Explore Identity & Access Solutions
              </Link>
              <Link
                href="/contact"
